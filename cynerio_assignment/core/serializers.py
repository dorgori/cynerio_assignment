...
from futbol.analytics.models import Team
from futbol.constants import PRE_SEASON, MD
from futbol.core.helpers import get_simulator_features
from futbol.planner.helpers import get_feature_empty_state
from futbol.planner.models import TrainingType, Training, TrainingPlan
...
class TrainingTypeSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model = TrainingType
		fields = ('id', 'name', 'is_match', 'in_season', 'typical_values')
